...
<td width="236">
<input name="a" type="text" value="<?php echo $_POST["a"] ?>" />
    X^2 + </td>
<td width="218"><label for="textfield3"></label>
<input type="text" name="b" id="textfield3" value="<?php echo $_POST["b"] ?>" />
      X+</td>
<td width="241"><label for="textfield"></label>
<input type="text" name="c" id="textfield" value="<?php echo $_POST["c"] ?>" />
      =0</td>
</tr>
<tr>
<td colspan="4">
